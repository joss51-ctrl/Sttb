/**
 * DewanDosenPage - Faculty & Leadership Directory
 * 
 * Features:
 * - Hierarchical structure showing organizational chart
 * - ROW 1: KETUA (The Head) - Large centered feature card
 * - ROW 2: WAKIL KETUA (Vice Chairs) - 3-column grid
 * - ROW 3: KETUA PROGRAM STUDI (Program Heads) - 4-5 column grid
 * - ROW 4: JAJARAN DOSEN (Faculty Members) - 5-column grid
 * 
 * Design:
 * - Professional academic aesthetic
 * - Navy Blue and Crimson Red accents
 * - Clean white cards with soft shadows
 * - Red accent line for senior positions
 */
      ...
      <section className="bg-gradient-to-br from-blue-900 to-blue-800 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-2 text-sm text-blue-200 mb-6">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-white">Dewan Dosen</span>
          </div>

          {/* Title */}
          <h1 className="text-4xl lg:text-5xl font-bold">Dewan Dosen</h1>
          <p className="text-xl text-blue-100 mt-4 max-w-3xl">
            Tim pengajar berkualitas dengan dedikasi tinggi untuk pendidikan teologi Reformed
          </p>
        </div>
      </section>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {ketua.education.map((edu, index) => (
                            <li key={index} className="flex items-start gap-2 text-gray-700" style={{ lineHeight: '1.5' }}>
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {wakilKetua.map((wakil, index) => (
                <div key={index} className="bg-white rounded shadow-md hover:shadow-lg transition-shadow overflow-hidden">
                  {/* Red Accent Line */}
                  <div className="h-1 bg-red-700" />
                    ...
                    <div>
                      ...
                      <ul className="space-y-1.5">
                        {wakil.education.map((edu, eduIndex) => (
                          <li key={eduIndex} className="text-sm text-gray-700" style={{ lineHeight: '1.5' }}>
                            • {edu}
                          </li>
                        ))}
                      </ul>
                  ...
                  <div className="p-4">
                    ...
                    <ul className="space-y-1">
                      {kaprodi.education.map((edu, eduIndex) => (
                        <li key={eduIndex} className="text-xs text-gray-700" style={{ lineHeight: '1.5' }}>
                          • {edu}
                        </li>
                      ))}
                    </ul>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 max-w-7xl mx-auto">
              {dosenTetap.map((dosen, index) => (
                <div key={index} className="bg-white rounded shadow hover:shadow-md transition-shadow overflow-hidden">
                  {/* Profile Image */}
                  <div className="p-3">
                    <ImageWithFallback
      ...
      <section className="py-16 bg-gradient-to-r from-blue-900 to-red-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Belajar dari para ahli teologi yang berpengalaman dan berkomitmen
          </p>
